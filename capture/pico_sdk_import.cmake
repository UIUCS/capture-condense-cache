...
if (NOT PICO_SDK_PATH)
    ...
    elseif (PICO_SDK_FETCH_FROM_GIT)
        ...
        message(FATAL_ERROR "PICO_SDK_PATH is not specified. Please set PICO_SDK_PATH in your environment or via cmake -DPICO_SDK_PATH=...")
    endif ()
endif ()

get_filename_component(PICO_SDK_PATH "${PICO_SDK_PATH}" REALPATH BASE_DIR "${CMAKE_CURRENT_BINARY_DIR}")
